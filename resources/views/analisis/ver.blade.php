          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ver Analisis</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                    <div class="card-body">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="name" name="nombre" value="{{$analisis->nombre}}" placeholder="Nombre de Analisis" disabled>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Precio</label>
                    <input type="text" class="form-control" id="email" name="precio" value="{{$analisis->precio}}" placeholder="Descripción" disabled>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Costo</label>
                    <input type="float" class="form-control" id="email" name="costo" value="{{$analisis->costo}}" placeholder="Precio" disabled>
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="name" name="porcentaje" value="{{$analisis->porcentaje}}" placeholder="Nombre de Analisis" disabled>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Tiempo de Respuesta</label>
                    <input type="text" class="form-control" id="email" name="tiempo" value="{{$analisis->tiempo}}" placeholder="Descripción" disabled>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Tipo de Tubo</label>
                    <input type="float" class="form-control" id="email" name="material" value="{{$analisis->material}}" placeholder="Precio" disabled>
                  </div>
